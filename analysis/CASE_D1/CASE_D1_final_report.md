# CASE_D1 Final Report: Day 1 — Childhood Wellbeing
...
|---|-------|----------|----------------|----------|--------|
| 1 | Balanced contentment, safety, and moral steadiness | Moderately prominent | 75 | 13 | 3 |
| 2 | Interdependent professional support ecology | Most prominent | 109 | 11 | 4 |
| 3 | Fragmented, strained childhood service conditions | Present but less prominent | 63 | 13 | 4 |
| 4 | Culturally grounded coordination and implementation | Highly prominent | 98 | 13 | 3 |
...
### Salience logic
Prominence ratings reflect a composite assessment of coded segment count, speaker diversity, table spread, and question coverage. Theme 2 is the most frequently coded across the broadest table and question range. Theme 4 is highly prominent with strong coded evidence in Q1–Q5. Themes 1 and 3 each draw on 13 speakers, but Theme 1 functions more as a conceptual foundation while Theme 3 concentrates its support in specific critiques of systemic failure.
...
**83 participant segments, 17 speakers, 5 sources**
...
**74 participant segments, 13 speakers, 4 sources**
...
**307 participant segments, 20 speakers, 5 sources — the most evidence-rich question**
...
**96 participant segments, 12 speakers, 4 sources**
...
**159 participant segments, 11 speakers, 3 sources**
...
**65 participant segments, 8 speakers, 4 sources**

Q6 has limited coded theme matches (only 5 segments mapped to Themes 2 and 3; zero mapped to Themes 1 and 4) because 60 of 65 participant segments are coded as `general_response`. The analytical content described below is based on close reading of the segment text, not automated code-to-theme mapping.
...
**Salience: Moderately prominent** — 75 coded participant segments, 13 speakers, 3 tables. Conceptually foundational but concentrated in Q1–Q5.
...
**Salience: Most prominent** — 109 coded participant segments, 11 speakers, 4 tables. Strongest across Q1–Q6.
...
**Salience: Highly prominent** — 98 coded participant segments, 13 speakers, 3 tables. Strong coded support in Q1–Q5.

**Important limitation**: The Q×Theme matrix shows zero coded Theme 4 segments for Q6 and Q7. This is because Q6 (60/65 segments) and Q7 (21/21 segments) are coded as `general_response` due to keyword-matching limitations. The Q6–Q7 content described below was identified through close reading and is analytically relevant to Theme 4 but is **not supported by automated code-to-theme mapping**. The recommendation workbook is auxiliary material and does not count as transcript-equivalent theme evidence.
...
|--------|-----------|-----------------|----------|--------------|------------------|
| HWCH0AR | 620 | 476 | 5 | T1, T2, T3, T4 | Largest transcript. Rich conceptual discussion (Q1–Q3). |
| HWCH2AR | 114 | 72 | 2 | T2, T3 | Arabic flowing text. Healthcare system critique. |
...
| Q2 | 9 / 5 | 3 / 2 | 1 / 1 | 7 / 4 |
| Q3 | 34 / 10 | 65 / 6 | 18 / 6 | 47 / 7 |
| Q4 | 8 / 4 | 9 / 4 | 23 / 7 | 13 / 6 |
| Q5 | 11 / 2 | 25 / 3 | 15 / 3 | 19 / 3 |
| Q6 | 0 / 0 | 2 / 1 | 3 / 1 | **0 / 0** |
| Q7 | 0 / 0 | 0 / 0 | 0 / 0 | **0 / 0** |

**Q6–Q7 note**: Zero coded Theme 1 and Theme 4 matches for Q6 and zero coded matches for all themes in Q7 because 60/65 (Q6) and 21/21 (Q7) participant segments are coded as `general_response`. This is a coding limitation, not an absence of thematically relevant content. See Sections 3.6–3.7 for close-reading analysis.
...
|------------|-------|----------|-------|-------------------|
| D1_P02 (healthcare professional) | T0 | 192 | 19,700 | Q1;Q2;Q3;Q5 |
| D1_P01 (psychiatrist) | T0 | 120 | 15,833 | Q1;Q2;Q3;Q5 |
| D1_P03 (mental health professional) | T0 | 102 | 13,163 | Q1;Q2;Q3;Q5 |
| D1_P10 (psychologist) | T6 | 63 | 26,630 | Q1;Q2;Q3;Q4;Q5;Q6 |
| D1_P07 (healthcare professional) | T2 | 47 | 18,975 | Q4 |
| D1_P04 (wellbeing researcher) | T0 | 37 | 6,280 | Q3 |
| D1_P15 (healthcare professional) | T7 | 35 | 12,656 | Q1;Q2;Q3;Q4;Q5;Q6;Q7 |
| D1_P16 (healthcare professional) | T7 | 30 | 9,365 | Q1;Q2;Q3;Q4;Q5;Q6;Q7 |
| D1_P05 (healthcare professional) | T0 | 25 | 2,032 | Q1;Q2;Q3 |
| D1_P06 (healthcare professional) | T2 | 25 | 10,255 | Q6 |
| D1_P11 (community volunteer) | T6 | 20 | 9,126 | Q3;Q5 |
| D1_P17 (healthcare professional) | T7 | 17 | 6,223 | Q1;Q2;Q3;Q4;Q5;Q7 |
| D1_P18 (healthcare professional) | T7 | 13 | 3,595 | Q1;Q3;Q4;Q5;Q6;Q7 |
| D1_P19 (healthcare professional) | T7 | 9 | 3,259 | Q1;Q3;Q6;Q7 |
| D1_P23 (occupational therapist) | T10 | 9 | 1,368 | Q1;Q2;Q3;Q4 |
